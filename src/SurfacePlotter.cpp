...
float SurfacePlotter::getZRange(void) { return this->zMax - this->zMin; }

float *SurfacePlotter::getVertices(void) { return this->vertices; }

uint SurfacePlotter::getNumElements(void) { return this->numElements; }
...
uint *SurfacePlotter::getCubeIndices(void) { return this->cubeIndices; }
